...
class SecondControlPage extends StatefulWidget {
  @override
  _SecondPageHorizontalState createState() => _SecondPageHorizontalState();
}

class _SecondPageHorizontalState extends State<SecondControlPage> {
